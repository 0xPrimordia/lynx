...
const GovernanceLayout: React.FC<GovernanceLayoutProps> = ({ children }) => {
    ...
    <div className="min-h-screen bg-black text-white">
      <div className="flex">
        ...
        <div className="w-64 bg-gray-900/50 border-r border-gray-800 min-h-screen">
          <div className="p-6">
            <h2 className={`text-2xl font-bold text-white mb-8 ${vt323.className}`}>
              Governance
            </h2>
