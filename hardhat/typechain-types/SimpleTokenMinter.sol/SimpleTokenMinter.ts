...
export namespace MintFailedEvent {
...
export interface SimpleTokenMinter extends BaseContract {
  ...
  getEvent(
    ...
    MintFailedEvent.InputTuple,
    MintFailedEvent.OutputTuple,
    MintFailedEvent.OutputObject
  >;
  getEvent(
    key: "MintSuccessful"
  ): TypedContractEvent<
  ...
  filters: {
    "MintFailed(address,int64,int64)": TypedContractEvent<
      MintFailedEvent.InputTuple,
      MintFailedEvent.OutputTuple,
      MintFailedEvent.OutputObject
    >;
    MintFailed: TypedContractEvent<
      MintFailedEvent.InputTuple,
      MintFailedEvent.OutputTuple,
      MintFailedEvent.OutputObject
    >;

    "MintSuccessful(address,int64,int64,int64)": TypedContractEvent<
      MintSuccessfulEvent.InputTuple,
      MintSuccessfulEvent.OutputTuple,
      MintSuccessfulEvent.OutputObject
    >;
